...
// Está importando os componentes do react-router-dom.
  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* Renderiza o componente Produto quando a rota: /produto for acessada. No path tem :id porque é uma rota dinâmica e o * é para indicar que pode ter mais coisas depois do id. */}
