...
const App = () => {
  ...
  // Retorna um elemento React.Fragment com o conteúdo da variável dados, um parágrafo com o valor da variável total e uma mensagem se o total for maior que 10000.
  return (
    <div>
