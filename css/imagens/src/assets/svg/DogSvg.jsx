...
// Criado um componente chamado DogSvg.
const DogSvg = ({ color, eyes }) => {
  // Retorna um SVG de um cachorro.
  return (
    <svg
      width="28"
      height="22"
    ...
    >
      <path
        ...
        fill={color}
      />
      <circle cx="21" cy={eyes} r={eyes} fill={color} />
      <circle cx="7" cy={eyes} r={eyes} fill={color} />
    </svg>
  );
};

export default DogSvg; // Está exportando o componente DogSvg.
